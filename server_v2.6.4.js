/**
 * Health America Backend — server_v2.6.4.js
 * Fix: Load .env so PORT and secrets are respected
 */
...
// Pick port from .env, fallback to 8880 if missing
...
app.get(['/','/health'], (req,res) => {
  res.json({ status:'UP', service:'Server Alex', version:'2.6.4', port: PORT });
});
